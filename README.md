...
**Placement.js** addresses a single use-case: positioning a popup to one side of an anchor element, optimizing the placement depending on the size of the popup:
